...
2) Создаём `.stylelintrc.json` в корне проекта и генериру пользовательские правила. Генератор: https://maximgatilin.github.io/stylelint-config/
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYyMTM4NTIzNCwtMjA5MDcyNjIwLC0xNT
I0NjY1MzAyXX0=
-->